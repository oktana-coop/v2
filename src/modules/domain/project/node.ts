...
export { createAdapter as createNodeMultiDocumentProjectStoreManagerAdapter } from './adapters/multi-document-project/git-project-store-manager/electron-node-fs';
