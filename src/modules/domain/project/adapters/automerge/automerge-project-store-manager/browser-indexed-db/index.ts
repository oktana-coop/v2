...
import { type ProjectStore, type ProjectStoreManager } from '../../../../ports';
...
const openExistingProject = ({
  ...
  listProjectDocuments: ProjectStore['listProjectDocuments'];
  findDocumentInProject: ProjectStore['findDocumentInProject'];
  deleteDocumentFromProject: ProjectStore['deleteDocumentFromProject'];
  addDocumentToProject: ProjectStore['addDocumentToProject'];
  listDirectoryFiles: Filesystem['listDirectoryFiles'];
  readTextFile: Filesystem['readTextFile'];
  db: IDBDatabase;
