...
export const Logo = ({
  ...
  if (theme === themes.dark) {
    return (
      ...
      >
        ...
        <rect x="78" y="118.263" width="60" height="12" fill="#FFA3A8" />
      </svg>
    );
  }
  ...
  return (
    ...
    >
      <path
        d="M138 95.1998V106.263L91.3878 106.115V94.6098L126.199 65.5509V50.8002H102.303V63.9283H91.0928V39.7371H138V73.0737L108.941 95.1998H138Z"
        fill="#9352FF"
      />
      <path
        d="M75.3803 39.7371L57.2369 106.263H36.1434L18 39.7371H33.0457L45.1413 95.6423H49.419L61.5146 39.7371H75.3803Z"
